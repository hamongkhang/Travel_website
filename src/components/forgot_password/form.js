                ...
                <div className="col-sm-12">
                  <div className="flex-content">
                    <div className="custom-form custom-form-fields">
                      ...
                      <form className="insertForm" onSubmit={addddPassword}>
                        <div className="form-group">
                          <input type="text" className="form-control" onChange={(event) => addPassword(event)} placeholder="Your User Name" id="user" name="user" required />
                          <span><i className="fa fa-user" /></span>
                        </div>
                        <div className="form-group">
                          <input type="text" className="form-control" onChange={(event) => addPassword(event)} placeholder="Your Email" id="email" name="email" required />
