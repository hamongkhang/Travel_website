          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                ...
                {bl.map(({id_blog,time_blog,author_blog,title_blog,img_blog,content_blog }) => {
  return(
    ...
    <div className="main-img blog-post-img">
      ...
      <div className="main-mask blog-post-info">
        <ul className="list-inline list-unstyled blog-post-info">
          ...
          <li><span><i className="fa fa-user" /></span>By: <a href="#">{author_blog}</a></li>
        </ul>
      </div>
    </div>
    {/* end blog-post-img */}
    <div className="blog-post-detail">
      <h2 className="blog-post-title">{title_blog}</h2>
      <p>
       {content_blog}</p>
      <p> {content_blog}</p>
      <p>
    ...
    {/* end blog-post-detail */}
                  ...
                  <div id="comments">
                    ...
                    {/* end comment-block */}
                    {comment.map(({id_blog,name_comment,email_comment,message,date_comment }) => {
  return(
    <div className="comment-block">
                      <div className="user-img">
                  ...
                  <div id="comment-form">
                    ...
                    <form className="insertForm" onSubmit={(event) => addComment(event,bl[0].id_blog)}>
                      <div className="row">
